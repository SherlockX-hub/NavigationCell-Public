...
%
% Modification:
% Smooth turning curve in a circular way with general.circSmooth;
% Smooth trajectory map as well.
%
...
%     trajectoryMap = general.smooth(trajectoryMap, smooth);
    ...
    tc(:, 2) = general.circSmooth(tc(:, 2), smooth);
    tc(:, 3) = general.circSmooth(tc(:, 3), smooth);
end
